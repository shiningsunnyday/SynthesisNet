...
We also release [pre-trained checkpoints](https://figshare.com/articles/dataset/SynthesisNet_surrogate_checkpoints/28557581). The ckpts/ folder should be {ckpt_dir} below. The .pkl files which may be needed are released [here](https://figshare.com/articles/dataset/SynthesisNet_assets/28658243).
